...
const CONFIG = {
  ...
  songLink: "https://youtu.be/jVug6gAdHuE?si=DkDDvev7vVdzP_KU", // example: "https://open.spotify.com/track/...."
  ...
  },
  {
    ...
    html: `
      ...
      <div class="couponGrid">
        <div class="coupon">unlimited video calls</div>
        <div class="coupon">unlimited hugs</div>
        <div class="coupon">your wish</div>
        <div class="coupon">movie night</div>
      </div>
    `
  },
  {
    ...
    html: `
      <p>This is our song. Tap to listen 🎧</p>

      <div class="songBox">
        <div class="songRow">
          <a class="btn btn-dark small" href="${CONFIG.songLink}" target="_blank" rel="noreferrer">Open on YouTube</a>
        </div>

        <div class="songRow">
          <div style="width:min(560px,100%); aspect-ratio:16/9; border-radius:14px; overflow:hidden; box-shadow:0 10px 22px rgba(0,0,0,0.12);">
            <iframe
              width="100%" height="100%"
              src="https://www.youtube-nocookie.com/embed/jVug6gAdHuE"
        ...
        <p class="tiny center">Optional: add a QR image at <strong>assets/qr.png</strong></p>
      </div>
    `
  },
  {
